      ...
      >
        ...
        {items.length > 0 && (
          ...
          >
            ...
            {freeHijabs > 0 && (
              <div className="relative overflow-hidden bg-gradient-to-r from-green-50 via-emerald-50 to-green-50 border-2 border-green-300 rounded-xl p-4 mb-3 shadow-sm">
